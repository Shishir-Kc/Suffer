/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 0305b79c7583c81598ab4a53bc1eee7a)
// Runtime types generated with workerd@1.20260921.1 2026-09-24
interface __BaseEnv_CloudflareBindings {
	DB: D1Database;
	COOKIE_NAME: "suffer_session";
	COOKIE_SAME_SITE: "Lax";
	B2_BUCKET_ID: "replace-with-b2-bucket-id";
	B2_BUCKET_NAME: "replace-with-b2-bucket-name";
	FACE_SERVICE_URL: "https://replace-with-vps-host";
	FACE_CALLBACK_URL: "http://localhost:8787/api/photos/callback";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "COOKIE_NAME" | "COOKIE_SAME_SITE" | "B2_BUCKET_ID" | "B2_BUCKET_NAME" | "FACE_SERVICE_URL" | "FACE_CALLBACK_URL" | "FRONTEND_ORIGIN">> {}
}
