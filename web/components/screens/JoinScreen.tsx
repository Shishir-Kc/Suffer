  ...
  return (
    <main className="entry-screen">
      ...
      <div className="brand-lockup">
        <span className="brand-bubble">S</span>
        <h1>Suffer</h1>
        <p>A trip game. Stay off your phone. Win or pay.</p>
      </div>
      <form
      ...
      <a className="quiet-link" href="/create">
        Create a trip instead
      </a>
      <p className="entry-footnote">
        No feed. No streaks. Just six friends and a little friendly suffering.
      </p>
    </main>
  );
}
